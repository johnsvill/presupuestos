...
namespace Presupuestos.Servicios.Usuarios
{
    public class UsuarioStore : IUserStore<Usuario>, IUserEmailStore<Usuario>, IUserPasswordStore<Usuario>
    {
        ...
        {
            user.Id = await this._repositorioUsuarios.CrearUsuario(user);
        ...
        {
            return await this._repositorioUsuarios.BuscarUsuarioPorEmail(normalizedEmail);
        }
        ...
        {
            return await this._repositorioUsuarios.BuscarUsuarioPorEmail(normalizedUserName);
        }
